...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      name: "Twitter",
      href: "https://www.linkedin.com/in/deepak-kumar-46b739322/",
    },
    {
      Icon: Instagram,
      color: footerStyles.instagramColor,
      name: "Instagram",
      href: "https://www.instagram.com/deepak_joshi58408/",
    },
    {
      Icon: Linkedin,
      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
          ...
          <div className={footerStyles.companySection}>
            <div className={footerStyles.logoContainer}>
              ...
              <div>
                <h2 className={footerStyles.companyName}>HealthPrime</h2>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 7322058408</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
        ...
        <div className={footerStyles.bottomSection}>
          <div className={footerStyles.copyright}>
            <span>© {currentYear} HealthPrime.</span>
          </div>

          <div className={footerStyles.designerText}>
            <span>Designed by</span>
            <a
              href="https://me-portfolio-24nq.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
